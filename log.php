...
<body>
    ...
    <div class="row">
        ...
        <div id="main_content" class="col-12 col-lg-8 d-flex justify-content-center rk_maincontent rk_border_collapse_mid rk_border_collapse_top">
            ...
            <br/>
            <button id="logrefresher">Refresh</button>
                <br/>
            <?php
            ...
            Graphics::generatetablefromDT($dt, "id=\"TBL_LOG\" class=\"basic_table\"", HeaderOptions::Custom, NullValues::Default , $customcolumns);
            ?>
            <br/>
